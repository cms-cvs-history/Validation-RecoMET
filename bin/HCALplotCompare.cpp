...
int main(int argc, char *argv[]) {
  ...
  PlotCompareUtility *pc = new PlotCompareUtility(argv[1],argv[2],"DQMData/RecoMETV/METTask/RecHits/HCAL/data","METTask_HCAL_");
  HistoData *hd;
  ...
  hd = pc->AddHistoData("D4_Occ_ieta_iphi"); hd->SetType(1); hd->SetValueX("CaloTower Occupancy");  
  hd = pc->AddHistoData("D3_Occ_ieta_iphi"); hd->SetType(1); hd->SetValueX("CaloTower Occupancy");
  hd = pc->AddHistoData("D2_Occ_ieta_iphi"); hd->SetType(1); hd->SetValueX("CaloTower Occupancy");
  hd = pc->AddHistoData("D1_Occ_ieta_iphi"); hd->SetType(1); hd->SetValueX("CaloTower Occupancy");

  hd = pc->AddHistoData("D4_Occvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring CaloTower Occupancy");
  hd = pc->AddHistoData("D3_Occvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring CaloTower Occupancy");
  hd = pc->AddHistoData("D2_Occvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring CaloTower Occupancy");
  hd = pc->AddHistoData("D1_Occvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring CaloTower Occupancy");

  hd = pc->AddHistoData("D4_METPhivsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring MET-#f (radians)");
  hd = pc->AddHistoData("D3_METPhivsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring MET-#f (radians)");
  hd = pc->AddHistoData("D2_METPhivsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring MET-#f (radians)");
  hd = pc->AddHistoData("D1_METPhivsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring MET-#f (radians)");

  hd = pc->AddHistoData("D4_MEyvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring METy (GeV)");
  hd = pc->AddHistoData("D3_MEyvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring METy (GeV)");
  hd = pc->AddHistoData("D2_MEyvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring METy (GeV)");
  hd = pc->AddHistoData("D1_MEyvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring METy (GeV)");

  hd = pc->AddHistoData("D4_MExvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring METx (GeV)");
  hd = pc->AddHistoData("D3_MExvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring METx (GeV)");
  hd = pc->AddHistoData("D2_MExvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring METx (GeV)");
  hd = pc->AddHistoData("D1_MExvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring METx (GeV)");

  hd = pc->AddHistoData("D4_METvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring MET (GeV)");
  hd = pc->AddHistoData("D3_METvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring MET (GeV)");
  hd = pc->AddHistoData("D2_METvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring MET (GeV)");
  hd = pc->AddHistoData("D1_METvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring MET (GeV)");
  
  hd = pc->AddHistoData("D4_SETvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring SET (GeV)");
  hd = pc->AddHistoData("D3_SETvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring SET (GeV)");
  hd = pc->AddHistoData("D2_SETvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring SET (GeV)");
  hd = pc->AddHistoData("D1_SETvsieta"); hd->SetType(2); hd->SetValueX("#eta-Ring SET (GeV)");
  
  hd = pc->AddHistoData("D4_energyvsieta"); hd->SetType(2); hd->SetValueX("CaloTower energy (GeV)");
  hd = pc->AddHistoData("D3_energyvsieta"); hd->SetType(2); hd->SetValueX("CaloTower energy (GeV)");
  hd = pc->AddHistoData("D2_energyvsieta"); hd->SetType(2); hd->SetValueX("CaloTower energy (GeV)");
  hd = pc->AddHistoData("D1_energyvsieta"); hd->SetType(2); hd->SetValueX("CaloTower energy (GeV)");
  ...
  for (int index = 0; index < pc->GetNumHistos(); index++) {
	...
	*/
    ...
    //h1dResultsnoTest.GetXaxis()->SetLabelSize(0.04);
    //h1dResultsnoTest.GetYaxis()->SetTitle("Compatibility");
